...
//  GPIO_PinAFConfig(GPIOA, GPIO_PinSource1, GPIO_AF_TIM5);
    ...
    TIM_TimeBaseStructure.TIM_Period = ACCURACY;             ///设置自动重装载值;10000
    ...
    TIM_OCInitStructure.TIM_OCPolarity = TIM_OCPolarity_High;///参数 TIM_OCPolarity 用来设置极性是高还是低;输出极性：TIM输出比较极性高；
